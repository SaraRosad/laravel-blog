    ...
    <div class="container">
        ...
        <div class="popular-tags-container d-grid">
            ...
            <a href="#" class="article">
                ...
                <img src="{{asset('assets/images/tags/technology-tag.jpg')}}" alt="" class="article-image">
            </a>

            <a href="#" class="article">
                <span class="tag-name">#Health</span>
                <img src="{{asset('assets/images/tags/health-tag.jpg')}}" alt="" class="article-image">
            </a>

            <a href="#" class="article">
                <span class="tag-name">#Nature</span>
                <img src="{{asset('assets/images/tags/nature-tag.jpg')}}" alt="" class="article-image">
            </a>

            <a href="#" class="article">
                <span class="tag-name">#Fitness</span>
                <img src="{{asset('assets/images/tags/fitness-tag.jpg')}}" alt="" class="article-image">
            </a>
