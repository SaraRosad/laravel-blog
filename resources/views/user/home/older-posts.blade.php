...
<section class="older-posts section">
    ...
    <div class="container">
        ...
        <div class="older-posts-grid-wrapper d-grid">
            ...
            <a href="#" class="article d-grid">
                <div class="older-posts-article-image-wrapper">
                    <img src="{{asset('assets/images/older_posts/older_posts_2.jpg')}}" alt="" class="article-image">
                </div>
            ...
            <a href="#" class="article d-grid">
                <div class="older-posts-article-image-wrapper">
                    <img src="{{asset('assets/images/older_posts/older_posts_3.jpg')}}" alt="" class="article-image">
                </div>
            ...
            <a href="#" class="article d-grid">
                <div class="older-posts-article-image-wrapper">
                    <img src="{{asset('assets/images/older_posts/older_posts_4.jpg')}}" alt="" class="article-image">
                </div>
            ...
            <a href="#" class="article d-grid">
                <div class="older-posts-article-image-wrapper">
                    <img src="{{asset('assets/images/older_posts/older_posts_5.jpg')}}" alt="" class="article-image">
                </div>
            ...
            <a href="#" class="article d-grid">
                <div class="older-posts-article-image-wrapper">
                    <img src="{{asset('assets/images/older_posts/older_posts_6.jpg')}}" alt="" class="article-image">
                </div>
